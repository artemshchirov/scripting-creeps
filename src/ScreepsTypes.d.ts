...
interface Creep extends RoomObject {
   ...
   */
  transfer(
    target: AnyCreep | Structure | SymbolDecoder | ScoreCollector,
   ...
   */
  withdraw(
    target: Structure | Tombstone | Ruin | SymbolContainer | ScoreContainer,
    resourceType: ResourceConstant,
    amount?: number
  ): ScreepsReturnCode;
}
...
interface PowerCreep extends RoomObject {
   ...
   */
  withdraw(
    target: Structure | Tombstone | Ruin | SymbolContainer,
    resourceType: ResourceConstant,
    amount?: number
  ): ScreepsReturnCode;
}
